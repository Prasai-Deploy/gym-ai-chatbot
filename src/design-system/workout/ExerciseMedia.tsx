    ...
    <div className={cn('relative w-full h-48 sm:h-64 rounded-3xl bg-slate-950/80 border border-white/10 overflow-hidden flex items-center justify-center select-none', className)}>
      {imageUrl ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 text-slate-500">
          <div className="w-16 h-16 rounded-3xl bg-brand-500/10 border border-brand-500/30 flex items-center justify-center text-brand-400">
      ...
      <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between pointer-events-none">
        <span className="px-3 py-1 rounded-xl bg-slate-900/90 backdrop-blur-md border border-white/10 text-xs font-bold text-brand-400">
          {muscleGroup}
        </span>
