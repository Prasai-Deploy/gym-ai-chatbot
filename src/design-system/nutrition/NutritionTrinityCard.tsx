...
export interface NutritionTrinityCardProps {
  insightText?: string;
  onAskTrinity?: () => void;
  className?: string;
}

export const NutritionTrinityCard: React.FC<NutritionTrinityCardProps> = React.memo(({
  insightText = "You're 32g short of your protein target. A protein-rich dinner would keep you on track.",
  onAskTrinity,
  className,
}) => {
  return (
...
NutritionTrinityCard.displayName = 'NutritionTrinityCard';
