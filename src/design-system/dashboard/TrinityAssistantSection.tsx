...
export interface TrinityAssistantSectionProps {
  insightText?: string;
  onOpenCoach?: () => void;
  className?: string;
}

export const TrinityAssistantSection: React.FC<TrinityAssistantSectionProps> = React.memo(({
...
TrinityAssistantSection.displayName = 'TrinityAssistantSection';
