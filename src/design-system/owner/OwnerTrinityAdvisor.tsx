...
export interface OwnerTrinityAdvisorProps {
  insightText?: string;
  onAction?: () => void;
  className?: string;
}

export const OwnerTrinityAdvisor: React.FC<OwnerTrinityAdvisorProps> = React.memo(({
...
OwnerTrinityAdvisor.displayName = 'OwnerTrinityAdvisor';
