        ...
        <section>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div>
              ...
              <p className="text-sm mt-2" style={{ color: 'var(--text-muted)' }}>Your personalized routines generated by STRIVA Coach</p>
            </div>
          ...
          <div className="space-y-4">
            {dashboardData?.today_plan ? (
              ...
              <div className="text-center py-16 border-2 border-dashed rounded-[32px]" style={{ color: 'var(--text-muted)', borderColor: 'var(--border-subtle)' }}>
                ...
                <p className="text-sm max-w-xs mx-auto">Ask STRIVA to generate a personalized workout and diet plan for you.</p>
              </div>
            )}
          </div>
        </section>
          ...
          >
            <div className="p-6 flex justify-between items-center" style={{ background: 'var(--surface-elevated)', borderBottom: '1px solid var(--border-subtle)' }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold" style={{ color: 'var(--text-primary)' }}>STRIVA Coach</h3>
            ...
            {/* Chatbot branding strip */}
            <div className="py-2 flex items-center justify-center gap-1.5 opacity-40 bg-zinc-950/40 border-t border-white/5">
              <span className="text-[8px] uppercase tracking-widest text-zinc-500">Powered by</span>
              <img src="/prasai_cloud_logo.png" alt="PrasAI Cloud" className="h-4 object-contain" />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
