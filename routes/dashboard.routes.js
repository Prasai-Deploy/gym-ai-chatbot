...
import { getDashboardHandler, logMetricsHandler, getLatestPlanHandler, getHistoryHandler, getProgressHandler, updateProgressHandler, saveAIPlanHandler, } from "../controllers/dashboard.controller.js";
const router = Router();
